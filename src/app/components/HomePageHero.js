...
export default function HomePageHero () {
  return (
    <section className="flex items-center h-screen relative px-[30px] lg:px-[60px]">
      ...
      <h1 className="overflow-hidden text-heading font-bold text-[45px] leading-[100%] xl:text-[120px] 2xl:text-[150px] xl:leading-[120px] 2xl:leading-[140px] uppercase mb-16">
        Frontend Developer
      </h1>
        ...
        <div className="xl:h-[100px] xl:w-[100px] 2xl:w-[125px] 2xl:h-[125px] flex items-center">
          <div className="animate-bounce">
            <svg className="translate-y-12 lg:translate-y-4" width="50px" height="100px" viewBox="0 0 80 40">
              <polyline fill="none" strokeWidth="4" strokeLinecap="inherit" strokeLinejoin="inherit" points="
            0,0 40,20 80,0"/>
            </svg>
          </div>
        </div>
