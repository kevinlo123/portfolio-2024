    ...
    <main className="my-[150px] md:my-[200px] mx-[30px] md:mx-[60px]">
      <section className="section-contact lg:flex">
        <div className="section-contact__inner lg:w-8/12">
          ...
          <h2 className="thank-you hidden font-bold text-white text-[40px] lg:text-[50px] mt-10">Message received! I&rsquo;ll get back to you soon. Check out my portfolio in the meantime!</h2>
