    ...
    return (
      <footer className="px-[30px] lg:pl-[0px]  lg:pr-[60px] lg:mx-10 mb-[100px] lg:mb-[200px] flex flex-col lg:flex-row mt-[50px] lg:mt-[100px]">
        <div className="lg:w-1/2">
          <a className="uppercase hover:bg-white hover:text-black transition-colors get-in-touch block text-center text-white text-[30px] w-full lg:!w-fit lg:text-[60px] rounded-full px-9 py-2 border border-white" href="/" >Get in touch</a>
        </div>
